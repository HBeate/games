...
public class ObjectsChangeDirection extends BasicGame {
    private Oval oval1;
    private Oval oval2;
    private Oval circle1;
    private Oval circle2;
    private Rectangle rectangle1;
    private Rectangle rectangle2;

    public ObjectsChangeDirection(String title) {
        super(title);
    }
    ...
    public void init(GameContainer gameContainer) throws SlickException {
        ...
        this.oval1 = new Oval(50, 50, 50, 20, 7, Direction.RIGHT);
        this.oval2= new Oval(700, 50, 50, 20, 7, Direction.LEFT);
        this.circle1 = new Oval(50, 50, 40, 40, 5, Direction.DOWN);
        this.circle2 = new Oval(50,150,15,15,3,Direction.UP);
    ...
    public static void main(String[] argv) {
        try {
            AppGameContainer container = new AppGameContainer(new ObjectsChangeDirection("Objects"));
